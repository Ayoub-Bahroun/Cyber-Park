...
export class ListeEntrepriseComponent implements OnInit {
  ...
  selectedEntreprise: entreprise | undefined;
  ...
  OpenModifierModal(id: number) {
    ...
    if (this.selectedEntreprise) {
      this.formModifierEntreprise.patchValue({
        nomEntreprise: this.selectedEntreprise.nomEntreprise,
        gerant: this.selectedEntreprise.gerant,
        mailEntreprise: this.selectedEntreprise.mailEntreprise,
        service: this.selectedEntreprise.service,
        siteEntreprise: this.selectedEntreprise.siteEntreprise
      });
    }
  }
